...
namespace AnylineXamarinApp.iOS
{
    class ResultOverlayView : UIView
    {
        ...
        {            
            ...
            this.Alpha = 0;
            this.Transform = CGAffineTransform.MakeScale((nfloat)0.2, (nfloat)0.2);

            UIView.Animate(0.3, 0, UIViewAnimationOptions.CurveEaseInOut, () =>
            {
                this.Alpha = 1;
                this.Transform = CGAffineTransform.MakeScale((nfloat)1.1, (nfloat)1.1);
            },
            () =>
            {
                UIView.Animate(0.2, 0, UIViewAnimationOptions.CurveEaseInOut, () =>
                {
                    this.Transform = CGAffineTransform.MakeScale((nfloat)1, (nfloat)1);
                }, null);
            });
        }
        ...
        public void AnimateFadeOut(UIView parent, Action resultAction)
        {
            ...
            if (this.Alpha == 1.0)
            {
                ...
                {
                    this.Alpha = 0;
                    this.Transform = CGAffineTransform.MakeScale((nfloat)0, (nfloat)0);
                }, resultAction);
            }
        }
    }
